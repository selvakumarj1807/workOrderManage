          ...
          />
              <div className="row justify-content-center">
                <div className="w-75 mx-md-5 mx-1 mx-sm-2 mb-5 mt-4 px-sm-5 px-md-2 px-xl-1 px-2">
                  <h1 className="wlcm">Welcome to <span style={{color:"#ff4133"}}>User</span> Login</h1>{" "}
                  <span className="sp1">
                    {" "}
            ...
            <div className="col-md-7 col-sm-12 col-xs-12 c2 px-5 pt-5">
              ...
              >
                ...
                <button className="text-white text-weight-bold bt">
                 <Link to="/" className='text-white'> Continue</Link>
                </button>
                <p>
                  Don't have an account?{" "}
                  <Link to="/user_register" className="ac" id="register"  style={{border:"none"}}>
                    Register
                  </Link>
                </p>
              </form>
